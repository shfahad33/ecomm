...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Somstore">F-Store</a></h1>
				<div id="top-nav">
					<ul>
...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<span class="midigta"> <a  class="a-btn" href="F-Store checkout/process.php"> <span class="a-btn-text"> Pay On F-Store</span></a></span>';
		echo '</span>';
		echo '</form>'; 
