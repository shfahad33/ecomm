    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				 ...
				 <h1><p> <a href="Sign In.php"><img src="images/logo1.png" alt="" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>F-Store  <strong>Login Form</strong> <span>Please Login Or Sign Up </span></p> </h1>
                        ...
                        <div id="login" class="animate form">
                            <form  action="userValidate.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="magaca" required="required" type="text" placeholder="fizatanveer32@gmail.com"/>
                                </p>
                                <p> 
                            ...
                            <form  action="employeeValidate.php" method="post" autocomplete="on"> 
                             <h1>Admin Login</h1> 
                                <p> 
                                    ...
                                    <input type="text" name="magaca" required="required" type="text" placeholder="username "/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your Password </label>
                                    <input type="password" name='furaha' required="required" type="password" placeholder="eg. *******" /> 
