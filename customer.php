...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="index.php" title="logo">logo</a></h1>
				<div id="top-nav">
					<ul>
				...
				<div class="col span_1_of_3">
      			...
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p><big> F-Store</big> Is A Online System Company Established In Pakistan</p>
						   		<p>  </p>
								 <BIG>PHONE</BIG>
				   		          <p>+92-(336)-4990950</p>
				   		          <BIG>EMAIL</BIG>
				 	 	          <p>F-Store@gmail.com</p>
								   <BIG>FOLLOW US</BIG>
