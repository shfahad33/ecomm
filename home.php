				...
				<ul class="slider-items">
					...
					<li>
						...
						<div class="slide-entry">
							...
							<li>
						<img src="images/fruit.png" alt="Slide Image" />
						<div class="slide-entry">
							<h3><span class="small">Fresh Fruits</span></h3> 
							
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
						<img src="images/veg.png" alt="Slide Image" />
						<div class="slide-entry">
							<h4><span>Fresh Vegetables</span></h4>
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					...
					YWe will be delightfull when you will shop online with F-Store. We will gives 100% surety about our products and services. We think about our customer convenience.  <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
			</div>
			<!-- End Content -->
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About F-Store</h2>
						<div class="box-entry">
							<img src="images/logo.png" alt="F-Store" width="160" height="80"/>
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title=" F-Store"><img src="images/logo.png" alt=" F-Store" /></a></li>
				
						</ul>
					</div>	<p>&copy; F-Store<a href="index.php"><i><font color="fefefe"> Welcome To F-Store Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
