...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">F-Store</a></h1>
				<div id="top-nav">
					<ul>
						...
						<div class="dd">
							<ul>
								<li>
									...
									<div class="dd">
										<ul>
                                            ...
                                            <li><a href="warehouse_1.php">Vegetables</a></li>
										</ul>
									</div>
								</li>
								...
								<li>
									...
									<div class="dd">
										<ul>
											  <li><a href="warehouse_2.php">Soft Drinks</a></li>
		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2021 F-Store.com All rights reserved. The information contained in SomStore.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of F-Store.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
