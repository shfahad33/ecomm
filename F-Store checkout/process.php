...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="abc@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="PK" countrynum="92" selected="">Pakistan</option>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="e.g. Lahore" type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> Phone:</label>
                                <input id="phone" name="phone" placeholder="e.g. +92-333-2314567" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="" type=" text" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
								Remember Sir If You Proceed it Now You Can Find Your Payment Voucher In Your Mail Box In A View Minutes.Happy Shopping
							</p>
                            <p class="submit">
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; F-Store.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To F-Store Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
