...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="logo">logo</a></h1>
				<div id="top-nav">
					<ul>
		...
		<div id="footer">
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About STORE</h2>
						<div class="box-entry">
							<img src="images/store.png" alt="IShop Logo" width="160" height="80"/>
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2021 F-Store.com All rights reserved. The information contained in F-Store.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of SomStore.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
