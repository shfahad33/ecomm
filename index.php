...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="logo">F-Store</a></h1>
					   ...
					   <li><a href="products.php"> Products</a></li>
						...
						<div class="dd">
							<ul>
								...
								<li>
									<a href="warehouse_3.php">House Stuff</a>
		...
		<div id="slider">
			...
			<div class="shell">
				<ul class="slider-items">
					<li>
						<img src="images/dr.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
							<h2><span> Women</span> Dresses </h2>
					
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
						<img src="images/s11.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
							<h4><span> Men</span> Dresses</h4>
							
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
						<img src="images/s12.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
							<h3><span> Suit</span> & Coats</h3> 
							...
							<li>
						<img src="images/fruit.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
							<h3><span> Fresh</span> Fruits </h3> 
							
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
						<img src="images/veg.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
							<h4><span> Fresh</span> Vegetables</h4>
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					...
					<li>
						<img src="images/clean.png" alt="Slide Image" width="980" height="340"/>
						<div class="slide-entry">
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About F-Store</h2>
						<div class="box-entry">
							<img src="images/store.png" alt="F-Store" width="160" height="80"/>
							<p>We will be delightfull when you will shop online with F-Store. We will gives 100% surety about our products and services. We think about our customer convenience. </p>
							<div class="cl">&nbsp;</div>
						</div>
					</div>
					...
					<div class="box last-box">
						...
						<ul>
							...
							<li><a href="#" title="Cleaning Material">Cleaning Stuff</a></li>
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="F-Store"><img src="images/store.png" alt="F-Store" width="160" height="80"/></a></li>
				
						</ul>
					</div>	<p>&copy; F-Store.com<a href="index.php"><i><font color="fefefe"> Welcome To F-Store Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2021 F-Store.com All rights reserved. The information contained in F-Store.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of F-Store.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
